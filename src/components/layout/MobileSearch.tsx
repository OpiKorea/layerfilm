                ...
                <div className="fixed inset-0 z-[100] bg-[#0a0a0a] flex flex-col p-6 animate-in slide-in-from-top duration-300">
                    ...
                    <form action="/explore" method="GET" className="relative group">
                        <input
                            ...
                            className="w-full h-16 bg-white/5 border border-white/10 rounded-2xl px-14 text-white text-xl focus:outline-none focus:border-accent transition-all shadow-inner"
                        />
                        <Search className="absolute left-5 top-5.5 w-6 h-6 text-gray-400" />
                        <button
                            type="submit"
                            className="mt-6 w-full h-14 bg-accent text-black font-bold rounded-2xl shadow-xl shadow-accent/20 active:scale-95 transition-all"
                        >
                            SEARCH
                        </button>
                    </form>
